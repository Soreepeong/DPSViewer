...
BOOL	InsertDynamicDetour( LPCSTR lpLibName, LPCSTR lpFnName, FARPROC pfnDetour );
BOOL	DirectX9Detour( UINT uOffset, FARPROC pfnDetour, FARPROC pfnOrig );
