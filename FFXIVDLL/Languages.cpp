...
namespace Languages {
	...
	void initialize() {
		...
		loc[LANGUAGE_ENGLISH]["OPTION_CHAT_HIDE"] = "Hide Chat";
		loc[LANGUAGE_ENGLISH]["OPTION_CHAT_SHOW"] = "Show Chat";
		...
		loc[LANGUAGE_ENGLISH]["OPTION_HEADER_TOOLS"] = "Tools###HEADER_TOOLS";
		...
		loc[LANGUAGE_KOREAN]["OPTION_CHAT_HIDE"] = u8"채팅 숨기기";
		loc[LANGUAGE_KOREAN]["OPTION_CHAT_SHOW"] = u8"채팅 보이기";
		...
		loc[LANGUAGE_KOREAN]["OPTION_HEADER_DPS"] = u8"DPS###HEADER_DPS";
		loc[LANGUAGE_KOREAN]["OPTION_HEADER_TOOLS"] = u8"도구###HEADER_TOOLS";
