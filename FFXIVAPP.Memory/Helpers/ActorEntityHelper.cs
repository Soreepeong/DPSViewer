    ...
    public static class ActorEntityHelper
    {
        public static ActorEntity ResolveActorFromBytes(byte[] source, bool isCurrentUser = false, ActorEntity entry = null)
        {
            ...
            try
            {
                ...
                entry.Type = Entity.Type[entry.TypeID = source[MemoryHandler.Instance.Structures.ActorEntity.Type]];
                entry.TargetType = Entity.TargetType[entry.TargetTypeID = source[MemoryHandler.Instance.Structures.ActorEntity.TargetType]];
                ...
                entry.ActionStatus = Entity.ActionStatus[entry.ActionStatusID = source[MemoryHandler.Instance.Structures.ActorEntity.ActionStatus]];
                ...
                entry.Icon = Entity.Icon[entry.IconID = source[MemoryHandler.Instance.Structures.ActorEntity.Icon]];
                entry.Status = Entity.Status[entry.StatusID = source[MemoryHandler.Instance.Structures.ActorEntity.Status]];
                ...
                entry.Job = Entity.Job[entry.JobID = source[MemoryHandler.Instance.Structures.ActorEntity.Job + defaultStatOffset]];
